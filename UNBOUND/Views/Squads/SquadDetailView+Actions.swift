// UNBOUND/Views/Squads/SquadDetailView+Actions.swift
import SwiftUI
...
extension SquadDetailView {
    ...
    @MainActor
    func refreshMemberProfiles() async {
    ...
    @MainActor
    func refreshMemberFrameTiers() async {
    ...
    @MainActor
    func refreshLeaderboardData() async {
        let roster = state.roster
    ...
    @MainActor
    func awardEndedSeasonWinnerIfEligible(now: Date = Date()) async {
    ...
    @MainActor
    func fetchWorkoutLogs(userId: String, limit: Int) async -> [WorkoutLog] {
    ...
    func isCurrentMember(_ member: SquadMember) -> Bool {

...
struct Step_Verdict: View {
    ...
    private var buildNarrative: String {
        ...
        return """
        Your protocol is tuned to your \(experiencePhrase) baseline \(equipPhrase). Priority work is \(focusPhrase) — where your current shape is furthest from the shape you want. With your \(commitPhrase) commitment, the math says you reach your first real milestone inside 60 days, and you keep climbing from there.
        """
    }

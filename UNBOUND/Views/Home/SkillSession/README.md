...
Related but intentionally elsewhere (pending a later regroup): `SetLoggerSheet.swift`, `SkillQuickLogSheet.swift`, `SkillSessionRestCombatViews.swift` in `Views/Home/`.

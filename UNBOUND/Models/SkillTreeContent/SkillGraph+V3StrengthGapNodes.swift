...
extension SkillGraph {
    static let v3StrengthGapNodes: [SkillNode] = [
        ...
        .simple(
            ...
            prereqs: [PrerequisiteGroup(["cl.hanging-leg-raise", "pp.dead-hang"])],
            equipment: [.pullupBar],
            primary: [.core, .lats],
        ...
        .simple(
            ...
            prereqs: [PrerequisiteGroup(["cl.dragon-flag-hip-raise", "cl.hollow-body-30"])],
        ...
        .simple(
            ...
            prereqs: [PrerequisiteGroup(["pp.strict-pullup", "pp.decline-row", "cl.hollow-body-30"])],
            equipment: [.pullupBar],
            primary: [.lats, .core],
        ...
        .simple(
            ...
            prereqs: [PrerequisiteGroup(["cl.tuck-front-lever", "pp.strict-pullup", "pp.decline-row"])],
            equipment: [.pullupBar],
            primary: [.lats, .core],
        ...
        .simple(
            ...
            prereqs: [PrerequisiteGroup(["cl.straddle-front-lever", "pp.weighted-pullup", "pp.decline-row", "cl.hollow-body-30"])],
            isKeystone: true,
            isMythic: true,
        ...
        .simple(
            ...
            prereqs: [PrerequisiteGroup(["cl.straddle-back-lever", "pp.weighted-pullup", "cl.german-hang", "cl.skin-the-cat"])],
            isMythic: true,
            equipment: [.pullupBar, .gymnasticRings],

...
extension SkillGraph {
    static let v3CalisthenicFoundationNodes: [SkillNode] = [
        ...
        .simple(
            ...
            prereqs: [PrerequisiteGroup(["pl.tuck-planche", "cal.pseudo-planche-pushup", "cal.l-sit-10"])],
            equipment: [.parallettes],
        ...
        .simple(
            ...
            prereqs: [PrerequisiteGroup(["pl.half-lay-planche", "cal.tuck-planche-pushup", "cal.pseudo-planche-pushup", "hs.crane-pose"])],
            isKeystone: true,
            isMythic: true,
            equipment: [.parallettes, .bodyweight],
        ...
        .simple(
            ...
            prereqs: [PrerequisiteGroup(["hs.wall-supported-oah", "hs.freestanding-hs-30"])],
            isKeystone: true,
            isMythic: true,
            primary: [.shoulders, .core],
        ...
        .simple(
            ...
            prereqs: [PrerequisiteGroup(["oah.one-arm-handstand-5s", "hs.wall-supported-oah"])],
            isMythic: true,
            primary: [.shoulders, .core],

...
enum ExerciseCatalog {
    ...
    static let exercisesByPattern: [MovementPattern: [CatalogExercise]] = [
        .legsQuad: [
            ...
            .init(name: "hack squat", displayName: "Hack Squat", muscleGroups: [.legs, .glutes], defaultSubstitute: "leg press"),
            ...
            .init(name: "v-squat machine", displayName: "V-Squat", muscleGroups: [.legs, .glutes], defaultSubstitute: "hack squat"),
            ...
            .init(name: "assisted squat", displayName: "Assisted Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: nil, progressionFamily: "legs-single", progressionTier: 0),
            .init(name: "parallel squat", displayName: "Parallel Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "assisted squat", progressionFamily: "legs-single", progressionTier: 1),
            .init(name: "bodyweight squat", displayName: "Bodyweight Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "parallel squat", progressionFamily: "legs-single", progressionTier: 2),
            .init(name: "split squat", displayName: "Split Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "bodyweight squat", progressionFamily: "legs-single", progressionTier: 3),
            .init(name: "bulgarian split squat", displayName: "Bulgarian Split Squat", muscleGroups: [.legs, .glutes], defaultSubstitute: "split squat", progressionFamily: "legs-single", progressionTier: 4),
            .init(name: "step up", displayName: "Step Up", muscleGroups: [.legs, .glutes], defaultSubstitute: "split squat", progressionFamily: "legs-single", progressionTier: 5),
            .init(name: "deep step up", displayName: "Deep Step Up", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "step up", progressionFamily: "legs-single", progressionTier: 6),
            .init(name: "cossack squat", displayName: "Cossack Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "bodyweight squat", progressionFamily: "legs-single", progressionTier: 7),
            .init(name: "partial pistol squat", displayName: "Partial Pistol Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "cossack squat", progressionFamily: "legs-single", progressionTier: 8),
            .init(name: "assisted pistol squat", displayName: "Assisted Pistol Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "partial pistol squat", progressionFamily: "legs-single", progressionTier: 9),
            .init(name: "pistol squat", displayName: "Pistol Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "assisted pistol squat", progressionFamily: "legs-single", progressionTier: 10),
            .init(name: "assisted shrimp squat", displayName: "Assisted Shrimp Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "pistol squat", progressionFamily: "legs-single", progressionTier: 11),
            .init(name: "beginner shrimp squat", displayName: "Beginner Shrimp Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "assisted shrimp squat", progressionFamily: "legs-single", progressionTier: 12),
            .init(name: "intermediate shrimp squat", displayName: "Intermediate Shrimp Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "beginner shrimp squat", progressionFamily: "legs-single", progressionTier: 13),
            .init(name: "weighted pistol", displayName: "Weighted Pistol Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "pistol squat", progressionFamily: "legs-single", progressionTier: 14),
            .init(name: "shrimp squat", displayName: "Shrimp Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "intermediate shrimp squat", progressionFamily: "legs-single", progressionTier: 15),
            .init(name: "two-hand shrimp squat", displayName: "Two-Hand Shrimp Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "shrimp squat", progressionFamily: "legs-single", progressionTier: 16),
            .init(name: "elevated two-hand shrimp squat", displayName: "Elevated Two-Hand Shrimp Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "two-hand shrimp squat", progressionFamily: "legs-single", progressionTier: 17),
            .init(name: "hip adductor machine", displayName: "Hip Adductor", muscleGroups: [.legs, .glutes], defaultSubstitute: "cossack squat"),
            .init(name: "walking lunge", displayName: "Walking Lunge", muscleGroups: [.legs, .glutes], defaultSubstitute: "step up"),
            .init(name: "reverse lunge", displayName: "Reverse Lunge", muscleGroups: [.legs, .glutes], defaultSubstitute: "walking lunge"),
            .init(name: "lateral lunge", displayName: "Lateral Lunge", muscleGroups: [.legs, .glutes], defaultSubstitute: "cossack squat"),
            .init(name: "curtsy lunge", displayName: "Curtsy Lunge", muscleGroups: [.legs, .glutes], defaultSubstitute: "reverse lunge"),
            .init(name: "front rack lunge", displayName: "Front Rack Lunge", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "walking lunge"),
            .init(name: "box squat", displayName: "Box Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "back squat"),
            .init(name: "zercher squat", displayName: "Zercher Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "front squat"),
            .init(name: "sissy squat", displayName: "Sissy Squat", muscleGroups: [.legs], defaultSubstitute: "leg extension"),
            .init(name: "single-leg press", displayName: "Single-Leg Press", muscleGroups: [.legs, .glutes], defaultSubstitute: "leg press"),
            ...
            .init(name: "jump squat", displayName: "Jump Squat", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "bodyweight squat"),
            .init(name: "bodyweight leg extension", displayName: "Bodyweight Leg Extension", muscleGroups: [.legs, .core], defaultSubstitute: "bodyweight squat"),
        ...
        .legsPosterior: [
            ...
            .init(name: "sumo deadlift", displayName: "Sumo Deadlift", muscleGroups: [.back, .legs, .glutes, .forearms], defaultSubstitute: "deadlift"),
            .init(name: "trap bar deadlift", displayName: "Trap Bar Deadlift", muscleGroups: [.back, .legs, .glutes], defaultSubstitute: "deadlift"),
            .init(name: "deficit deadlift", displayName: "Deficit Deadlift", muscleGroups: [.back, .legs, .glutes], defaultSubstitute: "deadlift"),
            .init(name: "snatch grip deadlift", displayName: "Snatch-Grip Deadlift", muscleGroups: [.back, .legs, .glutes, .traps], defaultSubstitute: "deadlift"),
            .init(name: "rack pull", displayName: "Rack Pull", muscleGroups: [.back, .legs, .glutes, .traps], defaultSubstitute: "deadlift"),
            .init(name: "romanian deadlift", displayName: "Romanian Deadlift", muscleGroups: [.legs, .glutes, .back], defaultSubstitute: "good morning"),
            .init(name: "stiff leg deadlift", displayName: "Stiff-Leg Deadlift", muscleGroups: [.legs, .glutes, .back], defaultSubstitute: "romanian deadlift"),
            ...
            .init(name: "power clean", displayName: "Power Clean", muscleGroups: [.back, .legs, .glutes, .traps, .shoulders], defaultSubstitute: "deadlift"),
            .init(name: "hang clean", displayName: "Hang Clean", muscleGroups: [.back, .legs, .glutes, .traps, .shoulders], defaultSubstitute: "power clean"),
            .init(name: "clean and jerk", displayName: "Clean & Jerk", muscleGroups: [.back, .legs, .glutes, .traps, .shoulders], defaultSubstitute: "power clean"),
            .init(name: "power snatch", displayName: "Power Snatch", muscleGroups: [.back, .legs, .glutes, .traps, .shoulders], defaultSubstitute: "power clean"),
            ...
            .init(name: "nordic curl negative", displayName: "Nordic Curl Negative", muscleGroups: [.legs, .glutes], defaultSubstitute: "leg curl (lying)", progressionFamily: "legs-nordic", progressionTier: 0),
            .init(name: "nordic curl", displayName: "Nordic Curl", muscleGroups: [.legs, .glutes], defaultSubstitute: "nordic curl negative", progressionFamily: "legs-nordic", progressionTier: 1),
            .init(name: "nordic curl arms overhead", displayName: "Nordic Curl Arms Overhead", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "nordic curl", progressionFamily: "legs-nordic", progressionTier: 2),
            .init(name: "tuck one-leg nordic curl", displayName: "Tuck One-Leg Nordic Curl", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "nordic curl arms overhead", progressionFamily: "legs-nordic", progressionTier: 3),
            .init(name: "one-leg nordic curl", displayName: "One-Leg Nordic Curl", muscleGroups: [.legs, .glutes, .core], defaultSubstitute: "tuck one-leg nordic curl", progressionFamily: "legs-nordic", progressionTier: 4),
        ...
        .pushHorizontal: [
            ...
            .init(name: "decline dumbbell press", displayName: "Decline Dumbbell Press", muscleGroups: [.chest, .arms], defaultSubstitute: "decline bench press"),
            .init(name: "floor press", displayName: "Barbell Floor Press", muscleGroups: [.chest, .arms, .shoulders], defaultSubstitute: "bench press"),
            .init(name: "dumbbell floor press", displayName: "Dumbbell Floor Press", muscleGroups: [.chest, .arms, .shoulders], defaultSubstitute: "floor press"),
            ...
            .init(name: "incline pushup", displayName: "Incline Push-Up", muscleGroups: [.chest, .shoulders, .arms, .core], defaultSubstitute: nil, progressionFamily: "push", progressionTier: 0),
            .init(name: "pushup", displayName: "Push-Up", muscleGroups: [.chest, .shoulders, .arms, .core], defaultSubstitute: "incline pushup", progressionFamily: "push", progressionTier: 1),
            .init(name: "diamond pushup", displayName: "Diamond Push-Up", muscleGroups: [.chest, .arms, .core], defaultSubstitute: "pushup", progressionFamily: "push", progressionTier: 2),
            .init(name: "decline pushup", displayName: "Decline Push-Up", muscleGroups: [.chest, .shoulders, .arms], defaultSubstitute: "pushup", progressionFamily: "push", progressionTier: 3),
            .init(name: "pseudo planche pushup", displayName: "Pseudo-Planche Push-Up", muscleGroups: [.chest, .shoulders, .arms, .core], defaultSubstitute: "decline pushup", progressionFamily: "push", progressionTier: 4),
            .init(name: "archer pushup", displayName: "Archer Push-Up", muscleGroups: [.chest, .shoulders, .arms, .core], defaultSubstitute: "pseudo planche pushup", progressionFamily: "push", progressionTier: 6)
        ],
        .pushVertical: [
            ...
            .init(name: "push press", displayName: "Barbell Push Press", muscleGroups: [.shoulders, .arms, .legs, .core], defaultSubstitute: "overhead press"),
            .init(name: "dumbbell overhead press", displayName: "Dumbbell OHP", muscleGroups: [.shoulders, .arms], defaultSubstitute: nil),
            .init(name: "seated dumbbell shoulder press", displayName: "Seated Dumbbell Shoulder Press", muscleGroups: [.shoulders, .arms], defaultSubstitute: "dumbbell overhead press"),
            ...
            .init(name: "thruster", displayName: "Barbell Thruster", muscleGroups: [.shoulders, .legs, .glutes, .core], defaultSubstitute: "push press"),
            ...
            .init(name: "dumbbell upright row", displayName: "Dumbbell Upright Row", muscleGroups: [.shoulders, .traps, .arms], defaultSubstitute: "upright row"),
        ...
        .pullHorizontal: [
            ...
            .init(name: "hammer strength high row", displayName: "High Row (Machine)", muscleGroups: [.back, .lats, .arms], defaultSubstitute: "lat pulldown"),
            ...
            .init(name: "seal row", displayName: "Barbell Seal Row", muscleGroups: [.back, .lats, .arms], defaultSubstitute: "chest supported row"),
            .init(name: "yates row", displayName: "Yates Row (Barbell)", muscleGroups: [.back, .lats, .arms], defaultSubstitute: "bent-over row"),
            .init(name: "incline dumbbell row", displayName: "Incline Dumbbell Row", muscleGroups: [.back, .lats, .arms], defaultSubstitute: "chest supported row"),
            .init(name: "smith machine row", displayName: "Smith Machine Row", muscleGroups: [.back, .lats, .arms], defaultSubstitute: "bent-over row"),
            .init(name: "renegade row", displayName: "Renegade Row (Dumbbell)", muscleGroups: [.back, .lats, .arms, .core], defaultSubstitute: "dumbbell row"),
        ...
        .pullVertical: [
            ...
            .init(name: "pullup", displayName: "Pull-Up", muscleGroups: [.back, .lats, .arms], defaultSubstitute: "chin-up", progressionFamily: "pull", progressionTier: 3),
            .init(name: "neutral grip pullup", displayName: "Neutral-Grip Pull-Up", muscleGroups: [.back, .lats, .arms], defaultSubstitute: "pullup"),
            ...
            .init(name: "chest-to-bar pullup", displayName: "Chest-to-Bar Pull-Up", muscleGroups: [.back, .lats, .arms], defaultSubstitute: "pullup")
        ],
        .arms: [
            ...
            .init(name: "seated dumbbell curl", displayName: "Seated Dumbbell Curl", muscleGroups: [.arms], defaultSubstitute: "dumbbell curl"),
            .init(name: "alternating dumbbell curl", displayName: "Alternating Dumbbell Curl", muscleGroups: [.arms], defaultSubstitute: "dumbbell curl"),
            ...
            .init(name: "drag curl", displayName: "Drag Curl", muscleGroups: [.arms], defaultSubstitute: "barbell curl"),
            .init(name: "reverse curl", displayName: "Reverse Curl (EZ-Bar)", muscleGroups: [.arms, .forearms], defaultSubstitute: "ez bar curl"),
            .init(name: "zottman curl", displayName: "Zottman Curl", muscleGroups: [.arms, .forearms], defaultSubstitute: "hammer curl"),
            .init(name: "cable curl", displayName: "Cable Curl", muscleGroups: [.arms], defaultSubstitute: "dumbbell curl"),
            .init(name: "high cable curl", displayName: "High Cable Curl", muscleGroups: [.arms], defaultSubstitute: "cable curl"),
            .init(name: "behind the back cable curl", displayName: "Behind-the-Back Cable Curl", muscleGroups: [.arms], defaultSubstitute: "cable curl"),
            ...
            .init(name: "cross-body hammer curl", displayName: "Cross-Body Hammer Curl", muscleGroups: [.arms, .forearms], defaultSubstitute: "hammer curl"),
            ...
            .init(name: "ez bar preacher curl", displayName: "EZ-Bar Preacher Curl", muscleGroups: [.arms], defaultSubstitute: "preacher curl"),
            ...
            .init(name: "single-arm tricep pushdown", displayName: "Single-Arm Tricep Pushdown", muscleGroups: [.arms], defaultSubstitute: "tricep pushdown"),
            .init(name: "reverse grip tricep pushdown", displayName: "Reverse-Grip Tricep Pushdown", muscleGroups: [.arms], defaultSubstitute: "tricep pushdown"),
            ...
            .init(name: "dumbbell overhead tricep extension", displayName: "Dumbbell Overhead Tricep Ext", muscleGroups: [.arms], defaultSubstitute: "overhead tricep extension"),
            .init(name: "single-arm overhead tricep extension", displayName: "Single-Arm Overhead Tricep Ext (Cable)", muscleGroups: [.arms], defaultSubstitute: "overhead tricep extension"),
            ...
            .init(name: "dumbbell tricep kickback", displayName: "Dumbbell Tricep Kickback", muscleGroups: [.arms], defaultSubstitute: "tricep pushdown"),
            .init(name: "cable tricep kickback", displayName: "Cable Tricep Kickback", muscleGroups: [.arms], defaultSubstitute: "dumbbell tricep kickback"),
            .init(name: "skull crushers", displayName: "Skull Crushers", muscleGroups: [.arms], defaultSubstitute: "tricep pushdown"),
            .init(name: "dumbbell skull crusher", displayName: "Dumbbell Skull Crusher", muscleGroups: [.arms], defaultSubstitute: "skull crushers"),
            ...
            .init(name: "bench dip", displayName: "Bench Dip", muscleGroups: [.arms, .chest, .shoulders], defaultSubstitute: "dip"),

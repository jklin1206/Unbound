...
enum ExerciseCatalog {
    ...
    static let exercisesByPattern: [MovementPattern: [CatalogExercise]] = [
        ...
        .pullVertical: [
            ...
            .init(name: "muscle-up", displayName: "Muscle-Up", muscleGroups: [.back, .lats, .arms, .chest], defaultSubstitute: "chest-to-bar pullup", progressionFamily: "pull", progressionTier: 7),

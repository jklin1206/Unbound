...
final class OnboardingFlowViewModel {
    ...
    // Widened from private to internal so extension files in separate files
    // (OnboardingFlowViewModel+Persistence.swift) can access these members.
    let userService: UserServiceProtocol
    let logger = Logger(subsystem: "com.unbound.app", category: "onboarding")
